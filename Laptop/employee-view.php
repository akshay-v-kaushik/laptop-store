...
<div class="sidenav">
	...
	<table align="right" id="table1" style="width:80%;margin-right:50px;">
		<tr>
			<th>Employee ID</th>
			<th>First Name</th>
			<th>Last Name</th>
	...
	include "config.php";
	$sql = "SELECT e_id, e_fname, e_lname, bdate, e_age, e_sex, e_jdate, e_sal, e_phno, e_mail, e_add FROM employee where e_id<>1";
