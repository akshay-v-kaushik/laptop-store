...
<div class="sidenav">
	...
	<?php
		...
		$sql="UPDATE employee
			...
			e_jdate='$jdate',e_sal='$sal',e_phno='$phno',e_mail='$mail',e_add='$add' where e_id='$id'";
			...
			<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
				...
				<div class="column">
					<p>
						...
						<input type="date" name="ejdate" value="<?php echo $row[6]; ?>">
					</p>
					<p>
						<label for="esal">Salary:</label><br>
						<input type="number" step="0.01" name="esal" value="<?php echo $row[7]; ?>">
					</p>
					<p>
						<label for="ephno">Phone Number:</label><br>
						<input type="number" name="ephno" value="<?php echo $row[8]; ?>">
					</p>
					
					<p>
						<label for="e_mail">Email ID:</label><br>
						<input type="text" name="e_mail"  value="<?php echo $row[9]; ?>">
					</p>
					<p>
						<label for="eadd">Address:</label><br>
						<input type="text" name="eadd"  value="<?php echo $row[10]; ?>">
					</p>
