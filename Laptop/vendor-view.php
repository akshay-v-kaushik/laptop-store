...
<div class="sidenav">
	...
	include "config.php";
	$sql = "SELECT ven_id,ven_name,ven_add,ven_phno,ven_mail FROM vendor";
	...
	echo "<tr>";
		...
		echo "<td>" . $row["ven_phno"]. "</td>";
		echo "<td>" . $row["ven_mail"]. "</td>";
		echo "<td align=center>";
		echo "<a class='button1 edit-btn' href=vendor-update.php?id=".$row['ven_id'].">Edit</a>";
		echo "<a class='button1 del-btn' href=vendor-delete.php?id=".$row['ven_id'].">Delete</a>";
		echo "</td>";
	echo "</tr>";
	}
	echo "</table>";
